...
- (void)mouseDown:(NSEvent *)event
{
	...
	if ([dataCell isKindOfClass:[NSButtonCell class]] || [dataCell isKindOfClass:[GCSColourCell class]]) {
...
#pragma unused(theEvent, untilMouseUp)
	...
	[GCSWindowMenu popUpWindowMenu:popup atPoint:loc withEvent:theEvent forView:controlView];
